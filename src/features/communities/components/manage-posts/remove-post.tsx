...
export const RemovePost = ({
  ...
  const handleConfirmRemove = () => {
    ...
    removePostMutation.mutate({ communityId, postId });
  };
  ...
  const isLoading = removePostMutation.isPending || penalizeMutation.isPending;
    ...
    <Dialog open={isConfirmOpen} onOpenChange={setIsConfirmOpen}>
      ...
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          ...
          <DialogDescription>
            This action will permanently delete &quot;{postTitle}&quot;. You can
            optionally penalize the author.
          </DialogDescription>
        </DialogHeader>
